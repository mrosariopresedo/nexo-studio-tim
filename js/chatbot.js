...
const INTENCIONES = [
  ...
  { claves: ['plataforma', 'anden', 'donde sale', 'que anden', 'que plataforma'],
    texto: 'Tu plataforma se confirma en los <strong>monitores</strong> de la terminal entre <strong>15 y 20 minutos antes</strong> de la salida. Si querés saberla por anticipado, usá la <a href="consulta-viajes.html" class="underline font-semibold">Consulta de viajes</a>.' },
  ...
  { claves: ['pasaje', 'boleto', 'comprar', 'boleteria', 'ticket', 'sacar'],
    texto: 'Comprás pasajes en las <strong>boleterías</strong> de cada empresa (ala Oeste). Para ver qué transporte tomar, plataforma y precio, usá la <a href="consulta-viajes.html" class="underline font-semibold">Consulta de viajes</a>.' },
